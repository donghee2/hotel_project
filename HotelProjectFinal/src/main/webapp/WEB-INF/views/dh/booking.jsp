...
<script type="text/javascript">
	$(function(){
		...
		$(".btn_down").click(function(){
			...
			if(total == 2) $('input[name="price"]').val(price);
			if(total > 2) {
					...
					<div class="sidebar">
						<div>
							<form action="booking.do">
								...
								<hr>
								<label>${booking.hotelName }</label><br>
								<label>${booking.roomType }</label>
								<input type="hidden" name="roomNo" value="${booking.roomNo }">
								<h4>인원</h4>
								<button type="button" class="btn_down" style="width: 30px;">-</button><input type="number" name="total" value="2" readonly="readonly" style="width: 40px; text-align: right; border: 1px solid black;"><button type="button" class="btn_up" style="width: 30px;">+</button><br>
								<input type="text" name="price" value="" style="width: 250px;"><br>
